...
const OUTCOME_CATALOG = Object.freeze({
  ...
  QUEUE_PROCESS_STARTED: {
    ...
    user_message: 'O processamento da fila foi iniciado em segundo plano.',
    retryable: false,
    defaultStatus: 'queued',
    httpStatus: 200,
  },
  QUEUE_PROCESS_ALREADY_RUNNING: {
    ...
    user_message: 'A fila já está sendo processada em segundo plano.',
    retryable: false,
  ...
  MONTH_RELEASE_STARTED: {
    category: 'success',
    title: 'Liberação iniciada',
    user_message: 'A liberação dos boletos do mês foi iniciada em segundo plano.',
    retryable: false,
    defaultStatus: 'queued',
    httpStatus: 200,
  },
  MONTH_RELEASE_ALREADY_RUNNING: {
    category: 'business_rule',
    title: 'Liberação já em andamento',
    user_message: 'Já existe uma liberação de boletos do mês em andamento para esta escola.',
    retryable: false,
    defaultStatus: 'processing',
    httpStatus: 200,
  },
